...
describe('core register systems', function () {
    ...
    it('should throw exception for dependency containg system name', function () {
        expect(COMP.System.Logic.bind({}, {
            ...
            requiredDependencies: ['SameEpicSystemLogic'],
            component: function () {},
            process: function () {}
        ...
        expect(COMP.System.IO.bind({}, {
            ...
            requiredDependencies: ['SameEpicSystemIO'],
            component: function () {},
            process: function () {}
        })).toThrow('system cannot depend on it self');
    });
    ...
    it('should process Logic, Interpolation and IO systems in correct order', function () {
        COMP.cycleOnce(function () {
            ...
            expect(systemExecutionPattern).toEqual([
                'SL2', 'SL1', 'L8', 'L6', 'L4', 'L2', 'L3', 'L7', 'L1', 'L5', 'L9',
                'SI2', 'SI1', 'I8', 'I6', 'I4', 'I2', 'I3', 'I1', 'I7', 'I9', 'I5',
                'SIO2', 'SIO1', 'IO8', 'IO6', 'IO4', 'IO2', 'IO3', 'IO1', 'IO7', 'IO9', 'IO5'
            ]);
    ...
    it('should process entities in the correct order', function () {
        COMP.cycleOnce(function () {
            ...
            expect(componentExecutionPattern).toEqual([
                ...
                'L5c-entity4', 'L5c-entity5', 'L9c-entity7',
        ...
        COMP.spiralCycle(function () {
            expect(componentExecutionPattern).toEqual([
                ...
                'IO8c-entity4', 'IO8c-entity5', 'IO2c-entity5', 'IO2c-entity6', 'IO3c-entity5', 'IO3c-entity6', 'IO3c-entity7', 'IO1c-entity5', 'IO1c-entity6', 'IO7c-entity5', 'IO9c-entity7', 'IO5c-entity5'
            ]);
    ...
    describe('remove entities', function () {
        ...
        it('should remove entities and process systems in correct order', function () {
            COMP.cycleOnce(function () {
                ...
                expect(componentExecutionPattern).toEqual([
                    'SL2c-staticEntity', 'SL1c-staticEntity',
                    'L8c-entity6', 'L2c-entity6', 'L3c-entity6', 'L3c-entity7', 'L7c-entity6', 'L1c-entity6', 'L9c-entity7',
            ...
            COMP.spiralCycle(function () {
                expect(componentExecutionPattern).toEqual([
                    'SL2c-staticEntity', 'SL1c-staticEntity', 'L8c-entity6', 'L2c-entity6', 'L3c-entity6', 'L3c-entity7', 'L7c-entity6', 'L1c-entity6', 'L9c-entity7',
                    'SL2c-staticEntity', 'SL1c-staticEntity', 'L8c-entity6', 'L2c-entity6', 'L3c-entity6', 'L3c-entity7', 'L7c-entity6', 'L1c-entity6', 'L9c-entity7',
                    'SL2c-staticEntity', 'SL1c-staticEntity', 'L8c-entity6', 'L2c-entity6', 'L3c-entity6', 'L3c-entity7', 'L7c-entity6', 'L1c-entity6', 'L9c-entity7',
                    'SL2c-staticEntity', 'SL1c-staticEntity', 'L8c-entity6', 'L2c-entity6', 'L3c-entity6', 'L3c-entity7', 'L7c-entity6', 'L1c-entity6', 'L9c-entity7',
                    'SL2c-staticEntity', 'SL1c-staticEntity', 'L8c-entity6', 'L2c-entity6', 'L3c-entity6', 'L3c-entity7', 'L7c-entity6', 'L1c-entity6', 'L9c-entity7',
                ...
                it('should remove system', function () {
                    COMP.cycleOnce(function () {
                        expect(systemExecutionPattern).toEqual([
                            ...
                            'L9', 'SI2', 'SI1', 'I8', 'I6', 'I4', 'I2', 'I3', 'I1', 'I7', 'I9', 'I5',
                            'SIO2', 'SIO1', 'IO8', 'IO6', 'IO4', 'IO2', 'IO3', 'IO1', 'IO7', 'IO9', 'IO5'
                        ]);
